  ...
  return (
    <div className="glass rounded-2xl p-6 h-[70vh] flex flex-col">
      <div className="flex items-center justify-between">
        ...
        <label className="text-xs text-neutral-400 flex items-center gap-2"><input type="checkbox" checked={triad} onChange={e=>setTriad(e.target.checked)} /> Triad Orchestration</label>
      </div>
